...
const EVENT_TYPES = [
  ...
  { href: '#/events#parties', label: 'Parties' },
  { href: '#/events#corporate', label: 'Corporate Events' },
  { href: '#/events#gatherings', label: 'Get-togethers' },
]
          ...
          <div className="footerGrid">
            ...
            <div ref={brandRef} className="footerBrand">
              ...
              <p className="footerTagline">
                Premium private space for conferences, parties, get-togethers, and corporate events.
              </p>
            ...
            <div ref={contactRef} className="footerCol">
              ...
              <div className="footerContact">
                <div className="contactItem">
                  ...
                  <span>4th floor, KUBERA TOWERS, Sampath Vinayaka Temple Rd, Visakhapatnam, 530003</span>
                </div>
                <div className="contactItem">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                  </svg>
                  <span>9849112369</span>
                </div>
                <div className="contactItem">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <span>sandeep9849112369@gmail.com</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="footerBottomInner">
            <p className="copyright">
              © {new Date().getFullYear()} The Zone. All rights reserved.
            </p>
